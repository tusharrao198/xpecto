...
dot2.addEventListener("click", () => {
    ...
    dot2.classList.add("active-timeline");
    dot1.classList.remove("active-timeline");
    dot3.classList.remove("active-timeline");
    dot4.classList.remove("active-timeline");
});
dot3.addEventListener("click", () => {
    ...
    document.querySelector(".block-4").style.display = "none";
    dot3.classList.add("active-timeline");
    dot2.classList.remove("active-timeline");
    dot1.classList.remove("active-timeline");
    dot4.classList.remove("active-timeline");
});
dot1.addEventListener("click", () => {
    ...
    document.querySelector(".block-3").style.display = "none";
    document.querySelector(".block-4").style.display = "none";
    dot1.classList.add("active-timeline");
    dot2.classList.remove("active-timeline");
    dot3.classList.remove("active-timeline");
    dot4.classList.remove("active-timeline");
});
dot4.addEventListener("click", () => {
    ...
    document.querySelector(".block-3").style.display = "none";
    document.querySelector(".block-1").style.display = "none";
    dot4.classList.add("active-timeline");
    dot1.classList.remove("active-timeline");
    dot2.classList.remove("active-timeline");
    dot3.classList.remove("active-timeline");
});
